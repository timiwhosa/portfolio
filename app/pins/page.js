    ...
    return(
        <div className="pb-10">
            ...
            <div className="grid grid-cols-2 gap-10 pl-10 pr-10 max-[440px]:gap-5">
                ...
                <Apin img="/img/pins/seeker.svg" title={"Seeker Ml"} pinterestLink="https://www.pinterest.com/timiwhosa/seeker/" />
            </div>
        </div>
    )
}
    ...
    return(
        <a href={pinterestLink} target="_blank">
            <div className="grid gap-2">
                <Image src={img} width={200} height={200} className="w-full h-auto rounded-lg border-2 border-black" alt="pinterest pins"/>
                <div className="flex justify-between">
                    <h2 className="font-bold max-2xl:text-xl  max-md:text-lg max-[440px]:text-xs">{title}</h2>
                    <Image src={"/img/rightUparrow.svg"} width={20} height={20} className="h-auto " alt="rightUparrow"/>
                </div>
            </div>
        </a>
    )
